...
Nine answers now receive limited historical credit; this is not an assignment-completion claim or new runtime evidence:
...
- **Across Week10: 9 checked, 115 pending, all 124 statements preserved.** A3–A5 are unchanged. The adjacent notes in both briefs attribute the reconciliation and distinguish completed historical work from missing live/human requirements. Historical receipt counts and flags remain exactly as recorded; no image bytes or metadata were rewritten.
...
- A1: PAT scope/storage requirements, the learner's own issue/resolution reflection and the universal secrecy assertion remain unchecked. Attributed technical notes describe actual trials, not learner reflection. The shared PAT is left unchanged; any new runtime work requires fresh authorization.
...
- Human review of the four A2 images, the unmet checklist requirements and the learner's own reflections. A1's seven-image review is user-attested; no checklist item or reflection was completed merely by attaching or approving images.

All original requirement text is preserved. The nine captured slots replace their redundant screenshot prompts, and A1's attributed technical notes replace its generic answer prompt while explicitly retaining the missing learner reflection. The [shared preservation contract](../submission/brief_contract.py) reverses only those substitutions, the historical preparation-notice correction, the two adjacent checklist-scope notes and exactly nine allowlisted checkbox answers to compare against unchanged original hashes. It rejects unsupported, duplicate, altered, reordered or missing completions rather than treating every checked box as acceptable. Image bytes, provenance, historical receipts and all unmet requirements remain unchanged. Passing these checks is not an assignment-completion or human-review claim.
