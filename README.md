...
| 08 | Terraform | 🔄 In Progress | [Assignment 6 — local drift-review deliverables; live evidence pending](./week-08-terraform/assignment-06-ai-assisted-terraform-drift-and-policy-review.md) | — | — |
...
- **Weeks 07–08:** no verified weekly publication links were found in the inspected repository or Medium feed. Week 08 Assignments 1–5 remain unfinished templates. Assignment 6 now has [implemented local drift-review deliverables and answers](./week-08-terraform/assignment-06-ai-assisted-terraform-drift-and-policy-review.md), with [passing local regression tests](./week-08-terraform/drift-review/reports/local-validation.json) and seven genuine local screenshots (2, 3, 4, 5, 6, 9 and 14). The [reproduction guide](./week-08-terraform/drift-review/README.md) explains the checker, skill, hook, fixture reports, isolated Terraform preparation and screenshot provenance. [Read-only AWS preflight](./week-08-terraform/drift-review/reports/live-preflight.json) verifies non-root access and tagged creation authorization, but cleanup permissions and Claude proxy connectivity remain unresolved. A deployed clean baseline, Claude Code runtime evidence, human-reviewed resolution, the other 12 numbered screenshots and publication remain pending. Fixture reports are not live infrastructure evidence; unfinished screenshot placeholders remain rather than implying completion.
