...
| 08 | Terraform | 🔄 In Progress | [Assignment 6 — live baseline/proposal and cleanup verified; human resolution, Claude review and publication pending](./week-08-terraform/assignment-06-ai-assisted-terraform-drift-and-policy-review.md) | — | — |
...
- **Week 06:** the Assignment 5 LinkedIn link uses the verified canonical `/posts/` URL. The evidence-backed [Week 06 reflection draft](./week-06-aws-cloud/reflection-week-06.md) is written, with source links and personal badge credit; public blog publication and verification are still outstanding. Assignment 4's [verification and evidence status](./week-06-aws-cloud/assignment-04-deploy-epicbook-on-ubuntu-vm-and-mysql-rds.md#deployment-verification-and-evidence-status) distinguishes the later deployment checks from the still-missing subnet, RDS public-access, and browser captures; its screenshot-backed Tasks 1, 5 and 9 remain open. The Assignment 5/6 technical limitations remain unchanged.
- **Weeks 07–08:** no verified weekly publication links were found in the inspected repository or Medium feed. Week 08 Assignments 1–5 remain unfinished templates. Assignment 6 documents [verified baseline/proposal/cleanup progress and rubric gaps](./week-08-terraform/assignment-06-ai-assisted-terraform-drift-and-policy-review.md). Under explicit creation/cleanup authorization, Copilot—not Claude or a manually operating human—applied reviewed saved plans for one dedicated VPC and closed, unattached security group. Both baselines returned plan exit 0; the LIVE checker returned HEALTHY/0. An **unapplied public-SSH configuration proposal**, not out-of-band drift, produced one update, FAIL/2 and zero refresh drift; deployed ingress stayed zero. Copilot removed the override for cleanup safety, verified a clean technical reset and deleted the lab through reviewed Terraform plans. [Cleanup at 18:25:59Z](./week-08-terraform/drift-review/reports/live/operations.json) verified empty states/inventory and exact-resource NotFound results. [Human resolution approval remains PENDING](./week-08-terraform/drift-review/reports/live/human-resolution.json); continuation permission and autonomous cleanup are not the user's personal review. [Claude inference failed with HTTP 403 enrollment authorization errors](./week-08-terraform/drift-review/reports/live/claude-runtime.json), so no successful review or runtime hook event/denial is claimed. Historical fixture/preflight evidence is preserved. **[14 genuine VS Code captures](./week-08-terraform/drift-review/README.md#genuine-local-screenshots) are integrated**; screenshots 10/12/15/16/17 and publication remain pending. This is not a completed agentic loop or full rubric pass.
