...
- **Weeks 07–08:** no verified weekly publication links were found in the inspected repository or Medium feed. Week 08 Assignments 1–5 remain unfinished templates. Assignment 6 now has [implemented local drift-review deliverables and answers](./week-08-terraform/assignment-06-ai-assisted-terraform-drift-and-policy-review.md), with [32 tests and 130 subtests passing](./week-08-terraform/drift-review/reports/local-validation.json). The [reproduction guide](./week-08-terraform/drift-review/README.md) explains the checker, skill, hook and fixture reports. A deployed clean baseline, Claude Code runtime evidence, human-reviewed resolution, screenshots and publication remain pending. Fixture reports are not live infrastructure evidence, and placeholders have not been removed to imply completion.
