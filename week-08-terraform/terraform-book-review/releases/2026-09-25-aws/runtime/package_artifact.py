...
from upstream import COMMIT, digest, load_deployment_lock as load_lock
...
def package(source, public_origin, versions, output):
    ...
    for path in sorted(source.rglob("*")):
        ...
        files[name] = data
    manifest = {"schema_version": 2, "release_id": lock["release_id"], "commit": COMMIT, "platform": "ubuntu-24.04-linux-amd64",
