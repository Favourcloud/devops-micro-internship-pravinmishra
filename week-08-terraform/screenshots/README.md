...
| 02 — AWS VM | 4 / 10 | [Images and manifest](../terraform-aws-vm/evidence/) |
...
There are **60 occupied numbered slots out of 118**. Most images for assignments 01–05 show local tools, source or initialization; they do not establish that cloud resources were deployed. See the [completion audit](../completion-audit.md) for the remaining work.
...
This is an unchanged copy of [Assignment 06 screenshot 13](../drift-review/screenshots/screenshot-13-live-detected-report.png), already recorded in its original manifest. It shows the saved report for a proposed unsafe ingress change. It does not show a new review, a deployed public SSH rule, or completion of another assignment. The copy is counted once in the 60-slot inventory.
